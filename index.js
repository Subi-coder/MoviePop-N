...
function rightSide() {
    const displayProperty = document.querySelector(".bestshows").scrollLeft += 300;
...
function rightSide2() {
    const displayProperty2 = document.querySelector(".tamilShows").scrollLeft += 300;
...
function leftSide2() {
    const displayProperty = document.querySelector(".tamilShows").scrollLeft -= 300;
    if (displayProperty <= 100) {
...
function rightSide3() {
    const displayProperty3 = document.querySelector(".englishShows").scrollLeft += 300;
...
function rightSide4() {
    const displayProperty4 = document.querySelector(".malayalamShows").scrollLeft += 300;
...
function rightSide5() {
    const displayProperty5 = document.querySelector(".teluguShows").scrollLeft += 300;
...
function rightSide6() {
    const displayProperty6 = document.querySelector(".hindiShows").scrollLeft += 300;
...
function rightSide7() {
    const displayProperty7 = document.querySelector(".kannadaShows").scrollLeft += 300;
...
function rightSide8() {
    const displayProperty8 = document.querySelector(".evergreenShows").scrollLeft += 300;
...
const clearChatBox = () => {
    ...
    chatBox.appendChild(createChatLi("Hi there !<br> How can i help you today ?", "incoming")); // Add default prompt
};
...
const getBotResponse = (input) => {
    ...
    switch (normalizedInput) {
        ...
        case 'what types of movies do you have':
            return 'Visit <a href="home.html">this page</a> for a list of movies.';
